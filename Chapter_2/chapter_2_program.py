...
from seaborn import FacetGrid  # trellis/lattice plotting
...
plt.figure()
plot = FacetGrid(dodgers, row = "day_night", col = "skies", hue = "bobblehead")
plot.map(plt.scatter, "temp", "attend_000")
plot.add_legend()
plt.show()
